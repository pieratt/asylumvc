...
const MainContent: React.FC = () => {
  return (
      ...
      <h2 className="text-2xl font-bold mb-8 text-center font-inconsolata">A LOVE LETTER</h2>
          <div className="grid grid-cols-1 gap-8 text-lg leading-7 font-inconsolata">
        <div className="space-y-4">
          <p>
            Sixteen years ago, I left Lehman Brothers in search of a calling. I spent a couple of years best described as meandering - writing, working odd jobs, grad school in Hong Kong - ultimately ending up back in NYC in 2009, having stumbled upon a young, passionate group of misfits that folks were calling “founders.” These founders felt more like artists than businesspeople, more obsessives than visionaries. They were mostly kids building the things that they wanted to see in the world (tumblr, vimeo, venmo, makerbot to name a few), and to my surprise, people called venture capitalists had given them money to pursue these dreams.
          </p>
          <p>
            ...
            <p>
                In many ways, this is what we all hoped for. To go from underdog to top dog, to build gigantic companies and make gigantic dollars, and surely I was a beneficiary of this growth. In 2021, during the height of ZIRP, I noticed I was as unhappy working in and funding startups as I had been working at Lehman in 2007 - The two industries had become almost indistinguishable from one another - No creativity or craft, purely focused on trying to squeeze out the extra dollar, before it all came crashing down. Good riddance I guess.
            </p>
        </div>
        <div className="space-y-4">
          <p>
            It’s now 2024, and Silicon Valley pushes a narrative that everyone should start a startup. I disagree. In many cases, both in good outcomes and bad, the requirements to build something truly new and important are hellish. Early-stage founders don’t want to work with banks because banks don’t understand how weird and hard it is to build something great, they don’t recognize that behind every email and board meeting there’s a trail of broken relationships, poor health, sleepless nights and bad ramen for the fifth night in a row.
                  ...
                  <blockquote className="py-20 text-xl italic text-center mb-8 w-full">
        ...
        <div className="space-y-4">
            <p>
            Asylum 2024 is a $55M fund, our first under this brand. We make $1-2M investments a few times per year and partner with founders raising their first capital in order to build something fundamentally new and beautiful. We lead with love and focus on people - we don’t give a shit if you have fancy degrees or credentials - we care about whether you’re obsessed with the problem and customer, whether you’re willing to do absurdly difficult things to perfect your craft and win, over a very long period of time. We’re a small team, we love art and great ideas, disgustingly ambitious and hard working and driven, we don’t offer big box platform services, it’s just us doing the actual work.
            </p>
            <p>
            Building companies is hard; Asylum aims to be the least-shitty part of that process, and we will never get in your way or ask you to do something that distracts from your mission. We expect you to be your authentically weird self, to build your company your way. Our primary service in addition to capital is trust - We’ve earned this trust with founders over the past 15 years, and we believe it has to be earned everyday going forward. We want to understand your motivations, but we don’t judge them. We care about money and returns to the extent that it allows us to continue to do what we do, but more than anything we just want to be close to greatness, both in the work we do and the founders we hope to work with. If we earn it, we’d like to partner with you for the rest of our lives, in many cases over multiple companies.
              </p>
        </div>
        <div className="space-y-4">
